      ...
      >
        {coupons.map((coupon) => {
          ...
          return (
            <div
              key={coupon.id}
              className="w-[270px] min-w-[270px] h-[192px] snap-start bg-white border border-gray-150 rounded-2xl relative overflow-hidden transition-all duration-300 hover:shadow-lg hover:-translate-y-0.5 group"
            >
              {/* Sliding Inner Container */}
              <div className="w-full h-full flex flex-col justify-between transition-transform duration-300 group-hover:-translate-y-[52px]">
                {/* Card Body */}
                <div className="p-4 flex-1 flex flex-col justify-between min-h-[192px] flex-shrink-0">
                  <div>
                    {/* Top Store Info */}
                ...
                {/* Bottom Action Area (Slides up) */}
                <div className="h-[52px] w-full flex flex-col justify-end flex-shrink-0">
                  {/* Scalloped Wavy Edge Separator */}
                  <div 
                    className="h-2 w-full relative overflow-hidden flex-shrink-0" 
                    style={{ 
                  ...
                  <button
                    ...
                    className="bg-primary hover:bg-[#C62F2F] text-white font-extrabold text-[13px] py-3.5 text-center transition-colors rounded-b-2xl w-full cursor-pointer flex-shrink-0"
                  >
