    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="bg-white rounded-2xl border border-gray-100 shadow-sm px-6 md:px-10 py-10 space-y-10 text-gray-700 text-sm leading-relaxed">
        ...
        <Section id="user-accounts" number="5" title="User Accounts">
          <SubSection title="5.1 Account Registration">
            ...
            <ul className="list-disc pl-5 space-y-1">
              ...
              <li>Notifying us immediately at <a href="mailto:beastultra59@gmail.com" className="text-primary hover:underline font-medium">beastultra59@gmail.com</a> if you suspect any unauthorised access</li>
            </ul>
          </SubSection>
        ...
        <Section id="governing-law" number="13" title="Governing Law and Dispute Resolution">
          ...
          <p>Before initiating any legal proceedings, you agree to first attempt to resolve any dispute by contacting us at <a href="mailto:beastultra59@gmail.com" className="text-primary hover:underline font-medium">beastultra59@gmail.com</a>. We will make reasonable efforts to resolve the dispute amicably within 30 days.</p>
        </Section>
